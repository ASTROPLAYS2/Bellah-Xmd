...
global.socialm = "IG: ka_ning_ka_kal_dawn" //ur github or insta name
global.location = "India" //ur location

//new
global.botname = process.env.BOT_NAME ||'۝AstrO۝' //enter your  bot name here
global.ownernumber = process.env.OWNER_NUMBER ||'917085345102' //ur owner number
...
global.packname = process.env.PACK_NAME ||"۝AstrO۝" //enter your stickers author name here
global.author = "۝AstrO۝"
global.creator = "917085345102@s.whatsapp.net"
global.xprefix = process.env.PREFIX ||'±'
global.premium = ["917085345102"] // Premium User
global.hituet = 0

//bot sett
global.typemenu = process.env.TYPE_MENU || 'v8' // menu type 'v1' => 'v8' 
global.typereply = process.env.TYPE_REPLY ||'v8' // reply type 'v1' => 'v3'
global.autoblocknumber = process.env.AUTOBLOCK_NUMBER || '263,234' //set autoblock country code
global.antiforeignnumber = process.env.ANTIFOREIGN_NUMBER || '1' //set anti foreign number country code
